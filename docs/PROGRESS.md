...
Latest audited checkpoint: 394 proof declarations; `lake build` successful (3601 jobs); standard axioms only; no placeholders or user axioms. The declaration count is not a completion percentage.
